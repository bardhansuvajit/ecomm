                ...
                <tr class="single" id="{{ $item->id }}">
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <div class="btn-group">
                                <a href="{{ route('admin.product.setup.usage.delete', $item->id) }}" class="btn btn-sm btn-dark" onclick="return confirm('Are you sure ?')" data-bs-toggle="tooltip" title="Delete">
