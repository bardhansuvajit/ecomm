                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <ul class="nav nav-underline">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('admin.product.variation.position') }}">Position</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <div class="form-group ml-2">
                                            <div class="btn-group">
                                                ...
                                                <a href="{{ url()->current() }}" class="btn btn-sm btn-light" data-toggle="tooltip" title="Clear filter" data-original-title="Clear filter">
