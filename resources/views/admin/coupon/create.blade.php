                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.coupon.store') }}" method="post">@csrf
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="" value="{{ old('name') }}" maxlength="1000">
                                @error('name') <p class="small text-danger">{{ $message }}</p> @enderror
                            </div>

                            <div class="form-group">
                                <label for="code">Code <span class="text-muted">*</span></label>
                                <input type="text" class="form-control" name="code" id="code" placeholder="" value="{{ old('code') }}" maxlength="255">
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="max_no_of_usage" id="max_no_of_usage" placeholder="99" value="{{ old('max_no_of_usage') }}" maxlength="5">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="user_max_no_of_usage" id="user_max_no_of_usage" placeholder="1" value="{{ old('user_max_no_of_usage') }}" maxlength="5">
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control" name="start_date" id="start_date" placeholder="" value="{{ old('start_date') ? old('start_date') : date('Y-m-d', strtotime('+1day')) }}" maxlength="5">
                                    @error('start_date') <p class="small text-danger">{{ $message }}</p> @enderror
                                </div>

                                <div class="col-md-4">
                                    <label for="expiry_date">Expiry date <span class="text-muted">*</span></label>
                                    <input type="date" class="form-control" name="expiry_date" id="expiry_date" placeholder="" value="{{ old('expiry_date') ? old('expiry_date') : date('Y-m-d', strtotime('+90days')) }}" maxlength="5">
                            ...
                            @foreach ($data->currencies as $cIndex => $currency)
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="percentage{{$cIndex}}" name="discount_type[{{$cIndex}}]" class="custom-control-input" value="2" checked>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" step=".01" class="form-control" name="discount_amount[]" id="discount_amount" placeholder="0.00" value="{{ old('discount_amount.'.$cIndex) }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" step=".01" class="form-control" name="minimum_cart_amount[]" id="minimum_cart_amount" placeholder="0.00" value="{{ old('minimum_cart_amount.'.$cIndex) }}">
