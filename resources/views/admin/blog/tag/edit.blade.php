        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.blog.tag.update') }}" method="post" enctype="multipart/form-data">@csrf
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    {!! imageUploadNotice('blog-tag-icon')['html'] !!}
                                ...
                                <div class="col-md-6">
                                    ...
                                    {!! imageUploadNotice('blog-tag-banner')['html'] !!}
