...
@section('page-title', 'Instagram Post detail')
                    ...
                    <div class="card-header">
                        <div class="row mb-3">
                            <div class="col-md-12 text-right">
                                ...
                                <a href="{{ route('admin.management.instagrampost.edit', $data->id) }}" class="btn btn-sm btn-primary"> <i class="fa fa-edit"></i> Edit</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
