                                ...
                                @forelse ($data as $index => $item)
                                    <tr class="single" id="{{ $item->id }}">
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <div class="btn-group">
                                                <a href="{{ route('admin.category.highlight.detail', $item->id) }}" class="btn btn-sm btn-dark" data-toggle="tooltip" title="View">
                                                    <i class="fa fa-eye"></i>
                                                </a>

                                                <a href="{{ route('admin.category.highlight.edit', $item->id) }}" class="btn btn-sm btn-dark" data-toggle="tooltip" title="Edit">
                                                    <i class="fa fa-edit"></i>
                                                </a>

                                                <a href="{{ route('admin.category.highlight.delete', $item->id) }}" class="btn btn-sm btn-dark" onclick="return confirm('Are you sure ?')" data-toggle="tooltip" title="Delete">
