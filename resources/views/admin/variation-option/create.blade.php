...
@section('page-title', 'Create variation option')
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.product.variation.option.store') }}" method="post" enctype="multipart/form-data">@csrf
                            <div class="form-group row">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="variation_id" id="variation_id">
                                        ...
                                        @forelse ($variations['data'] as $variation)
                                            <option value="{{$variation->id}}" {{ (old('variation_id') == $variation->id) ? 'selected' : '' }}>{{$variation->title}}</option>
                                        @empty
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="value" id="value" placeholder="" value="{{ old('value') }}" autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="category" id="category" class="form-control" placeholder="shoes,men,women" rows="2">{{ old('category') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="equivalent" id="equivalent" class="form-control" placeholder='{"name":"EURO 40"}' rows="2">{{ old('equivalent') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="information" id="information" class="form-control" placeholder='{"lenth":"25cm"}' rows="2">{{ old('information') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="short_description" id="short_description" class="form-control" placeholder="" rows="2">{{ old('short_description') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="long_description" id="long_description" class="form-control" placeholder="" rows="4">{{ old('long_description') }}</textarea>
