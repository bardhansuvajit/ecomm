...
@section('page-title', 'Variation option position')
                ...
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <ul class="nav nav-underline">
                                    <li class="nav-item">
                                        <a class="nav-link" aria-current="page" href="{{ route('admin.product.variation.option.list') }}">List</a>
                                    </li>
                                    <li class="nav-item">
                    ...
                    <div class="card-body">
                        <table class="table table-sm table-hover mb-3">
                            ...
                            <tbody class="sortable" data-position-update-route="{{ route('admin.product.variation.option.position.update') }}" data-csrf-token="{{ csrf_token() }}">
