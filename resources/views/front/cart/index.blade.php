                            ...
                            @foreach ($data->cart as $cartKey => $cart)
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10 col-8">
                                                <a href="{{ route('front.product.detail', $cart->productDetails->slug) }}" target="_blank">
                                                    <p class="mb-2 d-inline-block">{{ $cart->productDetails->title }}</p>
                                                </a>
                                                <div class="d-flex">
                                                    @if(!empty($cart->productDetails->offer_price))
                                                        {{-- sell price --}}
                                                        <p class="sell-price mb-0">&#8377;{{number_format($cart->productDetails->offer_price)}}</p>
                                                        {{-- mrp --}}
                                                        <p class="max-retail-price text-muted mb-0 mx-3">&#8377;{{ number_format($cart->productDetails->price) }}</p>
                                                        <p class="discount mb-0">{{ discountCalculate($cart->productDetails->offer_price, $cart->productDetails->price) }} OFF</p>
                                                    @else
                                                        {{-- sell price --}}
                                    ...
                                    <div class="cart-remove">
                                        <a href="{{ route('front.cart.remove', $cart->id) }}" class="small fw-600" onclick="return confirm('Are you sure?')">Remove</a>
                                    </div>
                                </div>
