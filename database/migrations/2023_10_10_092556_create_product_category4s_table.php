...
class CreateProductCategory4sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_category4s', function (Blueprint $table) {
            $table->id();

            $table->bigInteger('cat3_id');
            $table->string('title');
            $table->string('slug');
    ...
    {
        Schema::dropIfExists('product_category4s');
    }
}
