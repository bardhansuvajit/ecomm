...
class CreateProductCategory3sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_category3s', function (Blueprint $table) {
            $table->id();

            $table->bigInteger('cat2_id');
            $table->string('title');
            $table->string('slug');
    ...
    {
        Schema::dropIfExists('product_category3s');
    }
}
